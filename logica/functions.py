    ...
    for i in range(0, n-1):
        ...
        if i == 0:
            ...
            for x in range(0, h):
                ...
                if i % 2 == 0:
                    p = Partida(mandante=lista2[x], visitante=lista1[x], rodada=(
                        i+1), grupo=g, campeonato=c)
                    aux.append(p)
                else:
                    p = Partida(mandante=lista1[x], visitante=lista2[x], rodada=(
                        i+1), grupo=g, campeonato=c)
                    aux.append(p)
        else:
